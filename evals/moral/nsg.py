...
Usage:
    ...
    python -m evals.moral.nsg --phases 1 --no_cache
...
from domains.moral.data import CATEGORY_PARAPHRASES
...
def phase25_classify_responses(
    ...
    def _judge(cat, i, p, r):
        cls, raw = xstest_judge(p, r, model=gemini_model)
        return cat, i, cls, raw
